...
class Place {
  ...
  bool operator ==(Object other) {
    ...
    return other is Place && other.province == province && other.nepali == nepali && other.id == id && listEquals(other.district, district);
  }

  @override
  int get hashCode {
    return province.hashCode ^ nepali.hashCode ^ id.hashCode ^ district.hashCode;
  }
}
